...
### Configuring SITE[#](https://musings-of-an-adhd-tech-geek.vercel.app/posts/how-to-configure-astropaper-theme/#configuring-site) <a href="#configuring-site" id="configuring-site"></a>
...
### Configuring locale[#](https://musings-of-an-adhd-tech-geek.vercel.app/posts/how-to-configure-astropaper-theme/#configuring-locale) <a href="#configuring-locale" id="configuring-locale"></a>
...
### Configuring logo or title[#](https://musings-of-an-adhd-tech-geek.vercel.app/posts/how-to-configure-astropaper-theme/#configuring-logo-or-title) <a href="#configuring-logo-or-title" id="configuring-logo-or-title"></a>
...
You have to specify `logo.png` or `logo.svg` under `/public/assets` directory. Currently, only svg and png image file formats are supported. (_**Important!**_ _logo name has to be logo.png or logo.svg)_
...
### Configuring social links[#](https://musings-of-an-adhd-tech-geek.vercel.app/posts/how-to-configure-astropaper-theme/#configuring-social-links) <a href="#configuring-social-links" id="configuring-social-links"></a>
